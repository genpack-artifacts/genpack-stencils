...
#   download 'https://github.com/sorayuki/obs-multi-rtmp/releases/download/0.7.4.3/obs-multi-rtmp-0.7.4.0-x86_64-linux-gnu-ubuntu-24.04.deb' > /tmp/obs-multi-rtmp.deb
download $(get-github-download-url sorayuki obs-multi-rtmp 'obs-multi-rtmp-.*x86_64-linux-gnu-ubuntu-24\.04\.deb$') > /tmp/obs-multi-rtmp.deb
deb2targz /tmp/obs-multi-rtmp.deb
mkdir /tmp/obs-multi-rtmp
tar xvf /tmp/obs-multi-rtmp.tar.* -C /tmp/obs-multi-rtmp
